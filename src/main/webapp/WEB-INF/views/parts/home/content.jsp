                            ...
                            <c:choose>
                                <c:when test="${!empty info.location}">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <h3 class="my-4"> Redirecting</h3>
                                            <p>Currently, the updating process of the places is disabled. Your browser will be automatically redirected to the previously found results.</p>
                                        </c:otherwise>
                                    </c:choose>
                                </c:when>
                                <c:otherwise>
